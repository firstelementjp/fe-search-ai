...
- **GitHub Releases更新**: WordPress.org配布前でもGitHub Releasesから更新を受け取れます。
- **開発者向けフック**: プロバイダー、プロンプト、同期、表示、GitHub更新挙動を拡張できます。

## 現在のリリース

バージョン1.0.0では、BM25キーワードランキング、GitHub Releasesベースの更新、フル同期とリアルタイム同期のステータス分離、管理画面スタイル改善、日本語翻訳更新を追加しています。
