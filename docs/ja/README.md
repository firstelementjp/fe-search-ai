...
バージョン1.1.2では、AI生成Markdown HTMLに対するDOMPurifyサニタイズ、安全なリンク処理、暗号学的に安全なチャットセッションIDにより、フロントエンドチャットの安全性を強化しました。また、GitHub Actionsの権限を制限し、プラグイン承認後に明示的に有効化するまでWordPress.org SVNデプロイを無効化しました。
