...
| `fe_search_ai_system_log_forbidden_keys`            | `array $keys`, `string $level`, `string $message`, `array $data`   | Changes data keys removed from system log payloads before insertion.                                                                      |
| `fe_search_ai_system_log_payload`                   | `array $data`, `string $level`, `string $message`                  | Changes sanitized system log context data before insertion.                                                                               |
