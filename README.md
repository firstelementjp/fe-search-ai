...
[](https://fe-advanced-search.com/products/fe-ai-search/)
[](https://www.google.com/search?q=https://wordpress.org/plugins/fe-ai-search/)
[](https://www.gnu.org/licenses/gpl-2.0.html)

**AI-powered, conversational search for your WordPress site.**

FE AI Search replaces your standard WordPress search with a smart, conversational AI chat. It uses a RAG (Retrieval-Augmented Generation) model to provide accurate answers based *only* on your website's content, preventing hallucinations.
...
### Key Filter Hooks
  ...
  * **`fe_ai_search_retrieved_chunks`**: Modify the context chunks *after* they are retrieved from the database but *before* they are sent to the AI.
